...
//+kubebuilder:rbac:groups=curator.operatefirst.io,resources=reportapis,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=curator.operatefirst.io,resources=reportapis/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=curator.operatefirst.io,resources=reportapis/finalizers,verbs=update
